      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-8">
          ...
          {Object.entries(footerLinks).map(([title, links]) => (
            <div key={title}>
              <h3 className="font-medium text-sm uppercase tracking-wider text-primary mb-4">
                {title}
              </h3>
        ...
        {/* Bottom Bar */}
        <div className="border-t border-border/50 mt-8 pt-6 flex flex-col sm:flex-row justify-between items-center gap-2 text-sm text-muted-foreground">
          <p>© {new Date().getFullYear()} PrimeAdView. All rights reserved.</p>
          <p>
            Powered by{' '}
            <a
