  ...
  return (
    <>
      <div className="text-center mb-6">
        ...
        <p className="text-text-secondary mt-1">Start your earning journey with us today.</p>
      </div>

      {error && <p className="bg-red-900/50 text-red-300 p-3 rounded-md text-center mb-4 text-sm">{error}</p>}
      {message && <p className="bg-green-900/50 text-green-300 p-3 rounded-md text-center mb-4 text-sm">{message}</p>}
      ...
      <Button onClick={handleGoogleLogin} variant="outline" className="w-full flex justify-center items-center" disabled={loading}>
        <GoogleIcon />
        Sign up with Google
      </Button>
